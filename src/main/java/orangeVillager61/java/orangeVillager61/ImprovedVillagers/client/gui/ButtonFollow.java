...
public class ButtonFollow extends GuiButton{
	...
	public ButtonFollow(int buttonId, int x, int y, int widthIn, int heightIn, String buttonText, IvVillager villager) {
	...
	public void drawButton(Minecraft mc, int mouseX, int mouseY)
    {
        if (this.visible)
        {
            ...
            if (this.villager.getFollowing()){
            	this.displayString = "Following";
            }
            else{
            	this.displayString = "Follow";
            }
